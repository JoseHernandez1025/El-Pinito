...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <img src="<?php echo base_url; ?>img/logo.jpg" alt="Logo" style="width:40px;" class="rounded-pill">
            <a class="navbar-brand ps-3" href="index.html">El Pinito</a>
